...
class HighVolumeAutoPartsCatalog:
    ...
    def determine_category_vectorized(name_series: pl.Series) -> pl.Series:
        categories_map = {
            'Фильтр': 'фильтр|filter', 'Тормозная система': 'тормоз|brake|колодк|диск|суппорт',
            'Подвеска': 'амортизатор|стойк|spring|подвеск|рычаг*|Рычаги|Шаровая опора|Сайлентблок*|Ступиц*|подшипник ступицы|подшипники ступицы', 
